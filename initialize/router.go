...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitStudentRouter(PrivateGroup)               // 学生管理相关功能
		router.InitGradeRouter(PrivateGroup)                 // 年级管理相关功能
		router.InitClassRouter(PrivateGroup)                 // 班级管理相关功能
		router.InitTeacherRouter(PrivateGroup)               // 教师管理相关功能
		router.InitCourseRouter(PrivateGroup)                // 学科管理相关功能
		router.InitExamRoomRouter(PrivateGroup)              // 考场管理相关功能
