...
type Teacher struct {
	...
	Birthday    time.Time `json:"birthday" form:"birthday" gorm:"column:birthday;type:date;comment:出生日期"`
	Sex         int       `json:"age" form:"age" gorm:"column:age;comment:性别 1表示男，2表示女。"`
